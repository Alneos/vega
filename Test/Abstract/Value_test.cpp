...
#define BOOST_TEST_MODULE value_tests
...
BOOST_AUTO_TEST_CASE( valueOrReference_ref ) {
	ValueOrReference ref1(Reference<NamedValue>(Value::Type::FUNCTION_TABLE, 1, 5));
	ValueOrReference ref2(Reference<NamedValue>(Value::Type::FUNCTION_TABLE, 2, 6));
	ValueOrReference val2(2);
