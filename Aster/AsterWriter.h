...
//	std::set<int> singleGroupCellPositions;
	...
	void writeAffeCaraElemPoutre(const AsterModel&, Beam&, std::ostream&);
	...
	void writeNodalDisplacementAssertion(const AsterModel&, const NodalDisplacementAssertion&, std::ostream&) const;
	void writeNodalComplexDisplacementAssertion(const AsterModel&, const NodalComplexDisplacementAssertion&, std::ostream&) const;
	void writeNodalCellVonMisesAssertion(const AsterModel&, const NodalCellVonMisesAssertion&, std::ostream&) const;
	void writeFrequencyAssertion(const Analysis&, const FrequencyAssertion&, std::ostream&) const;
